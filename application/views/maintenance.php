...
<head>
    ...
    <link href="<?php echo base_url('assets/custom/animate/animate.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/custom/pinterest/pinterest.css'); ?>" rel="stylesheet">
