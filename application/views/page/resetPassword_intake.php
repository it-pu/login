    ...
    function saveNewPassword() {
        ...
        if(formNewPassword!='' && formNewPassword!=null && formNewPasswordRe!='' && formNewPasswordRe!=null){
            ...
            if(formNewPassword==formNewPasswordRe){
                // Cek apakah password < 5 karakter
                if(formNewPassword.length>=5){
                    var url = "<?php echo base_url('updatepassword_intake'); ?>"
                    ...
                    $.post(url,{token:token},function (result) {
                        if (result == 0) {
                            toastr.error('Token expired, failed reset password','');
                        ...
                        else
                        {
                            ...
                            setTimeout(function () {
                                window.location.href="<?php echo url_registration.'/login'; ?>";
                            },500);
                        }
                    });
                    ...
                    toastr.error('Password less than 5 character','Error');
                }
            } else {
